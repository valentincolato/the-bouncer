...
export function HUD({ gameState, className }: HUDProps) {
  return (
    <div className={cn("flex gap-2 md:gap-4", className)}>
      ...
      <div className="flex md:hidden bg-white border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] p-2 gap-1 flex-col items-center min-w-[80px]">
...
export function StatCard({ icon: Icon, label, value, color, bgColor, size = 'small', hideIcon = false }: any) {
  return (
    <div className={cn(
